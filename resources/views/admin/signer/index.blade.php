...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var signer = new Signer({
            url: {
                'ajaxList': '{!! route('admin.signer.ajax.list') !!}',
                'ajaxCreate': '{!! route('admin.signer.ajax.create') !!}',
                'ajaxUpdate': '{!! route('admin.signer.ajax.update') !!}',
                'ajaxDelete': '{!! route('admin.signer.ajax.delete') !!}',
                'ajaxOrganizationListOnly': '{!! route('admin.organization.ajax.listOnly') !!}',
            },
            lang: {
                'trans': {
